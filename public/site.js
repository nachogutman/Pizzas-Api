...
function getAll() {
  ...
  hide();
  axios
    .get("http://localhost:912/api/pizzas")
    .then((result) => {
...
function getById() {
  ...
  axios
    .get(`http://localhost:912/api/pizzas/${id}`)
    .then((result) => {
...
function deleteId() {
  ...
  axios
    .delete(`http://localhost:912/api/pizzas/${id}`)
    .then((result) => {
...
function insert() {
  ...
  const options = {
    method: 'POST',
    url: `http://localhost:912/api/pizzas`,
    headers: {
...
function update() {
  ...
  const options = {
    method: 'PUT',
    url: `http://localhost:912/api/pizzas/${document.getElementById('idUpdate').value}`,
    headers: {
      'content-type': 'application/json',
      'X-RapidApi-Key': 'your-rapidapi-key',
      'X-RapidApi-Host': 'microsoft-translator-text.p.rapidapi.com',
